...
run(){
  ...
  exp_dir=../roberta_bc5cdr_ner_reproduce/${wandb_run_name}

  CUDA_VISIBLE_DEVICES=0 python ./run_bc5cdr_ner_lora.py \
...
# LoRA baseline, same config style as sarcasm_detection_finetune.sh.
run "8" "1" "base"

# MELoRA run, same config style as sarcasm_detection_finetune.sh.
run "8" "2" "me"
